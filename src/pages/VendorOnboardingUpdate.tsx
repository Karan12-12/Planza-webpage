          ...
          {(entry.imagePreviewUrls.length > 0 ||
            ...
            <div className="grid grid-cols-3 gap-2 mb-2">
              {(entry.existingImageUrls || []).map((url, i) => (
                ...
                >
                  <img
                    src={`${import.meta.env.VITE_BASE_URL_FOR_FILE || ""}/uploads/vendor/portfolio/images/${url}`}
                    alt=""
                    className="w-full h-full object-cover"
                  />
        ...
        setFormState({
          ...
          portfolio: portfolioItems.map((p: any) => ({
            ...
            existingThumbnailUrl: p.ThumnailFileName
              ? `${import.meta.env.VITE_BASE_URL_FOR_FILE || ""}/uploads/vendor/portfolio/images/${p.ThumnailFileName}`
              : "",
            images: [],
            imagePreviewUrls: [],
          ...
          existingCoverImageUrl: vendor.CoverImageFileName
            ? `${import.meta.env.VITE_BASE_URL_FOR_FILE || ""}/uploads/vendor/portfolio/images/${vendor.CoverImageFileName}`
            : "",
