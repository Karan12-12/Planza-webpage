  ...
  portfolio: [
    {
      ...
      budget: "₹40,000",
      summary:
        "A dreamy rooftop setup with fairy lights, floral arches, and a live acoustic duo.",
      thumbnail:
    ...
    },
    {
      ...
      budget: "₹18,000",
      summary:
        "Intimate garden proposal with rose petals, candles, and a personalized photo wall.",
      thumbnail:
    ...
    },
    {
      ...
      budget: "₹55,000",
      summary:
        "Traditional meets modern — marigold garlands, brass décor, and a live dhol performance.",
      thumbnail:
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {vendor.services.map((s) => (
              <span
                key={s}
                className="text-xs border border-[#7c5cbf] text-[#7c5cbf] rounded-full px-3 py-1 font-medium"
              >
                {s}
              </span>
            ))}
